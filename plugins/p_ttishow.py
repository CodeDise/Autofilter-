...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('• ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ •', url=f'https://t.me/codedise_support')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://telegram.me/codedise_support'),
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://telegram.me/codedise')
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton('• ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇs •', url='https://t.me/codedise')
                                                                         ]]
                                                 ),
